...
- [ ] [ROUTINE] **Committed fixture snapshot for the WARN→ERROR boundary** (promoted from TODO id:cb3e; meeting D3/A1 — REPLACES the refuted git-blame dating) — UNGATED 2026-07-24 review (dep id:5533 shipped, relay-ckpt-20260724-1632) <!-- children-of:968c --> <!-- id:cb3e -->
