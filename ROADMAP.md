...
- [ ] [ROUTINE] instrument that the three JS-side dispatch backstops FIRE — persist each fire durably to the `relay-events.jsonl` history so fire-frequency is measurable over a window of runs (id:854c) <!-- id:854c -->
...
- [ ] [HARD — decision gate] Delete the id:000d/9973/ad74 JS-side backstops once the LLM-RUNNER-transport-infidelity residual is proven constrained (flip follow-on; meeting 2026-07-01-1904) <!-- id:b50e -->
