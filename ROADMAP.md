...
- [ ] [ROUTINE] **A STRANDED `relay/*` branch and a leftover worktree DIRECTORY are invisible to every sweep -- reconcile enumerates only `relay/orphan/*` and relay-doctor delegates to it.** -- detail: `docs/ledger-notes/ba95.md` <!-- id:ba95 -->
