...
- [ ] [ROUTINE] 🔴 **`workflow_node_check` returns 0 -- a silent PASS -- on a file it could not read: awk and sed both fail and their status is discarded.** -- detail: `docs/ledger-notes/1b0e.md` <!-- relates:62c9 --> <!-- id:1b0e -->
- [ ] [ROUTINE] **`workflow_node_check` refuses a whole file for a line-initial `export`/`import` inside a template literal or a block comment.** -- detail: `docs/ledger-notes/e044.md` <!-- relates:62c9 --> <!-- id:e044 -->
- [ ] [ROUTINE] 🔴 **The Workflow runtime is STRICT (probed, 2026-09-08), so the sloppy wrapper in `workflow_node_check` passes strict-only syntax errors that crash the pool.** -- detail: `docs/ledger-notes/ad67.md` <!-- relates:62c9 --> <!-- id:ad67 -->
