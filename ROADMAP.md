...
- [ ] [ROUTINE] purity-test-as-contract: shared `tests/lib/assert-repo-unchanged.sh` helper + documented convention (id:758e) <!-- id:758e -->
...
- [ ] [ROUTINE] `relay-gap-sample` hardening: hermetic test green + `make install-gap-sample`/`uninstall-gap-sample` + SKILL.md doc line (id:bf7a) <!-- id:bf7a -->
