...
- [ ] **[ROUTINE]** **Base-ref resolution must use the repo's ACTUAL checked-out branch — never a hard-coded `origin/main` → `main` → `master` guess** (owner ruling 2026-08-26; PROPAGATION of the already-ratified id:8739 posture to the two remaining offenders, not a new design) <!-- id:758a -->
