...
- [x] [ROUTINE] **`meeting/personas.md` has accreted redundant entries because `merge=union` can never reconcile a re-registration** <!-- id:069b -->
...
- [ ] **[ROUTINE]** classify-repo.sh: pass priority_rank + evidence through into the --emit unit dict — seam of id:c7dc (auto, id:3801) <!-- id:258d -->
