...
- [x] [ROUTINE] **`roadmap-tick.sh` ticks every `worked_ids` id unconditionally, so an executor reporting PARTIAL progress has its item closed and archived.** -- detail: `docs/ledger-notes/963c.md` <!-- relates:5b12 --> <!-- relates:64f9 --> <!-- id:963c -->
