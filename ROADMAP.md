...
- [x] [ROUTINE] **Author the systemd units + hardening for the two relay service users (authoring half of `id:8e7a`)** — see TODO.md for the full spec <!-- children-of:8e7a --> <!-- id:5bef -->
