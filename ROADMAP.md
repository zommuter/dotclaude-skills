...
- [ ] [ROUTINE] **The parked `id:4d65` attempt is red two ways, BOTH now localized and both small: a stale fixture in a neighbouring test, and a one-token typo in its own declaration.** -- detail: `docs/ledger-notes/95a3.md` <!-- relates:4d65 --> <!-- id:95a3 -->
