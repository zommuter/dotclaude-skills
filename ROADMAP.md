...
- [x] [ROUTINE] **The `id:2964` fix has TWO halves and only one is pinned: reverting the `_MARKER_RE` shape anchor alone leaves the whole suite green, because every over-match fixture is backticked and the quoted-example mask suppresses it first.** -- detail: `docs/ledger-notes/32ba.md` <!-- relates:2964 --> <!-- relates:8372 --> <!-- id:32ba -->
