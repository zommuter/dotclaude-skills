...
- [ ] [ROUTINE] 🔴 **REFUTED 2026-09-08 -- `list --tsv` never dropped the pending entry; the test grepped a 40-char sha against a field `main` renders as 12 chars.** -- detail: `docs/ledger-notes/ceca.md` <!-- relates:4d65 --> <!-- relates:95a3 --> <!-- id:ceca -->
