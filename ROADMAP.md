...
- [ ] [ROUTINE] **Nothing detects that a RUNNING `mechanical-proxy.py` predates an `ALLOWED_RELAY_SCRIPTS` change — the source-vs-process staleness that caused this whole incident is invisible to every existing check** <!-- routed:d9a5 --> <!-- routed:8b75 --> <!-- id:9e48 -->
