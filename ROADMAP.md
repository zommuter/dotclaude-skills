...
- [ ] [ROUTINE] **`recordAgentFailure()` is wired into the provision paths ONLY — every other mechanical hop still swallows its failure silently, so `id:06a1`'s accumulator under-reports** <!-- children-of:06a1 --> <!-- id:a104 -->
