...
- [ ] [ROUTINE] **`top_intensive`'s human-gated exclusion list is OLD-VOCAB ONLY — a new-vocab human-gated `[INTENSIVE]` item will be auto-dispatched** <!-- id:7517 -->
...
- [ ] [ROUTINE] **Parked-section vocab match is a bare substring — a heading that merely mentions `archive`/`done`/`gated`/etc. in descriptive prose parks its whole section** <!-- id:6446 -->
