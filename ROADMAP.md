...
- [ ] [ROUTINE] **OBSERVED (n=1): `tests/test_redispatch_suppression_e3b7.sh` flaked in the full suite** — record, do not chase yet <!-- id:98ea -->
  - **Evidence 2026-07-28**: full suite reported `317 passed, 1 failed` naming this file; an immediate re-run gave `318 passed, 0 failed`, and standalone it is 6/6. So: passes in isolation, failed once under full-suite load.
