...
- [x] [HARD] **Build the opt-in proxy stdin channel** (`` ```relay-mech-stdin ``) — carries the id:a05c option-B ruling. **APEX lane (owner 2026-07-28): this is security-boundary code and is NOT executor work**, regardless of how bounded the acceptance set looks. <!-- children-of:a05c --> <!-- id:33b2 -->
