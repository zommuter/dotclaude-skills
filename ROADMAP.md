...
- [ ] [HARD] **`classify-verdict.sh`'s strict rank order starves `hard` and `handoff` INDEFINITELY -- three victims now (hard dispatch, review cadence, promotion itself); fix the CHAIN, not a branch reorder.** -- detail: `docs/ledger-notes/4e84.md` <!-- routed:71c6 --> <!-- id:4e84 -->
