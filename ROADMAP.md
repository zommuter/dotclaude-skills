...
- [x] **[ROUTINE]** Surface todo-conformance.sh's INERT baseline warnings from relay-doctor.sh, and widen install-drift to cover all of relay_FILES — seam of id:4839 (auto, id:3801) <!-- id:cb9a -->
...
- [x] [ROUTINE] **`verify-negative-cases.py` accepted a MOVING `fails-against-rev`, so a rotted declaration reported VACUOUS.** Closed this review (46430e8e, d0635878); see REVIEW_ME 2026-09-09. <!-- relates:78e6 --> <!-- relates:a73c --> <!-- id:0801 -->
