...
- [ ] **[ROUTINE]** relay-loop.js: emit pushEvent('verdict', {repo, round, verdict, priority_rank, reason, sig, cached}) once per repo per round, including reused-cache repos (after id:(seam 2's id)) — seam of id:c7dc (auto, id:3801) <!-- id:e87d -->
