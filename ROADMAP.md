...
- [x] [ROUTINE] **Committed fixture snapshot for the WARN→ERROR boundary** (promoted from TODO id:cb3e; meeting D3/A1 — REPLACES the refuted git-blame dating) 🚧 GATED (DEP: 5533) <!-- gated-on:5533 --> <!-- children-of:968c --> <!-- id:cb3e --> — DONE 2026-07-24: baseline file + `state_claim_in_baseline` wired into both linters (`tests/test_state_claim_baseline_cb3e.sh`, suite 306/0/0).
