...
- [ ] [HARD] **`ledger-shrink.py` relocates HEAD-LINE prose only, so it has no lever on a continuation-heavy ledger -- decide whether it grows a continuation mode or ROADMAP gets a different tool.** <!-- gated-on:b048 --> <!-- id:40c0 -->
