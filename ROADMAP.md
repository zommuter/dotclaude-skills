...
- [ ] [ROUTINE] Refactor `relay/scripts/reconcile-repo.sh` into a pure PLANNER + thin APPLIER — add `--dry-run` that emits the plan JSON with ZERO side effects (parity oracle for relay-core ebdb-b) <!-- id:77ce -->
