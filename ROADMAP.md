...
- [ ] [ROUTINE] **`stopReason:"drained"` must ASSERT no actionable work remains** — RED spec authored 2026-07-28 (handoff C3), NOT implemented <!-- children-of:c919 --> <!-- id:d6f0 -->
  ...
  - **Out of scope**: when rounds are scored dry (id:c919, landed), the K=2 threshold, the `blocked-pending-human` path (id:4ca8).
