...
- [ ] [HARD — meeting] Inbox auto-reconcile on cross-repo `/relay`+`/meeting` activity (respect `--exclude`); folds id:3947 <!-- id:678e -->
  ...
  - **Spec / red test**: deferred to the meeting (the auto-mutation contract needs the design call first); id:3441 ships the detection + surfacing half that de-risks this.
