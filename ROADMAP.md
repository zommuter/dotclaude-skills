...
- [ ] [ROUTINE] **BUG: dry-round termination counts a WORK-CREATING handback as no-progress → the pool stops holding seams it just filed** (promoted from TODO `routed:b945`, loderite 2026-07-28) <!-- id:c919 -->
