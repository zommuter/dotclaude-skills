...
- [ ] [ROUTINE] **Word-boundary-anchor the `lib-state-claim.sh` terminal-word regex (fixes the compound-word false-positive class)** (filed 2026-07-24 review of id:5533) <!-- id:78e1 -->
