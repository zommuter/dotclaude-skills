...
- [x] [ROUTINE] **`workflow_node_check`'s lexical scan goes blind over 1,251 of relay-loop.js's 4,930 lines: a `//` comment holding a glob like `relay/orphan/*` opens a never-closing block-comment state.** -- detail: `docs/ledger-notes/8627.md` <!-- relates:e044 --> <!-- id:8627 -->
