...
- [x] [ROUTINE] **`statusline-command.sh` hardcodes its four `/tmp` usage-state paths — make them env-overridable so the suite is hermetic** (reverse-handoff of TODO id:ec3c, mini-handoff at review 2026-08-13) <!-- id:ec3c -->
