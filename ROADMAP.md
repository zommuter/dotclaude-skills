...
- [ ] **[HARD]** Build relay/scripts/integrate.sh — standalone mechanical integrator (all 11 deterministic steps, fail-closed LOUD), tested in isolation — seam of id:a955 (auto, id:3801) <!-- id:9e50 -->
