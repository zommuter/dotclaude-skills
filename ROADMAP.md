...
- [ ] [HARD] **Build the `/inflownistration` skill -- three modes plus a parameter-less ROUTER, scope RATIFIED 2026-08-21 (promoted from TODO.md id:32c3, single-id-two-views)** -- detail: `docs/ledger-notes/32c3.md` <!-- id:32c3 -->
