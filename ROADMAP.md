...
- [ ] [ROUTINE] **Count a BLOCKED/failed `agent()` dispatch into `state.agentFailures` — the classifier-block channel and the failure-accumulator channel are still disjoint** <!-- children-of:83c2 --> <!-- id:3222 -->
