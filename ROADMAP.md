...
- [x] **[ROUTINE]** `count-indented-ids.py` does not satisfy id:8679's own RED spec: no positional-path invocation, no enumeration in DEFAULT output, no stated counting rule (review run relay-20260908-174448-4421) <!-- relates:8679 --> <!-- id:0f0a -->
