...
- [ ] [INPUT — decision] **Pre-register the burn-ranking decision rule — THE GATE that orders id:a955 and id:3ca7** <!-- children-of:1f4f --> <!-- id:87f5 -->
...
- [ ] [ROUTINE] **Make `@owner-gated` a FIRST-CLASS exclusion in `lib-roadmap-sections.sh` — the PREREQUISITE for `id:6446`** <!-- id:f391 -->
