...
- [x] [ROUTINE] Review→execute chaining within a pool — **emit a `review→execute re-enqueue` EVENT into `relay-events.jsonl`** (RE-LANED from `[INPUT — access]` 2026-08-14, `/relay human .`, OWNER-DECIDED: "Mechanize it — emit an event") — see TODO.md <!-- id:b8ae -->
