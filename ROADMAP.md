...
- [ ] [ROUTINE] **Shared two-directional state-claim contradiction predicate — one engine, two linters (AMENDS id:dafa)** (promoted from TODO id:5533; meeting D2/D5/A3 + the 2026-07-24 owner amendment folding in the 0e99 direction) <!-- children-of:968c --> <!-- id:5533 -->
...
- [ ] [ROUTINE] **Anchored `settles:` / `decided-in:` typed-edge grammar + `orphan-scan --unbackrefed` / `--settled`** (promoted from TODO id:8913; meeting D1/A2) <!-- children-of:968c --> <!-- id:8913 -->
...
- [ ] [ROUTINE] **Committed fixture snapshot for the WARN→ERROR boundary** (promoted from TODO id:cb3e; meeting D3/A1 — REPLACES the refuted git-blame dating) 🚧 GATED (DEP: 5533) <!-- gated-on:5533 --> <!-- children-of:968c --> <!-- id:cb3e -->
