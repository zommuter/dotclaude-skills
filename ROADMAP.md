...
- [ ] [ROUTINE] `roadmap-lint.sh` tag-first rule — flag an open item whose genuine lane tag is NOT the first recognized lane-tag (a prose/backtick'd lane bracket precedes it) (id:ad8a) <!-- id:ad8a -->
