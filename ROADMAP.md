...
- [ ] [ROUTINE] **Remove the `pipefail` + early-exiting-pipe-consumer race repo-wide, and lint it so it cannot return** — this is the FIX for the cause diagnosed under `id:7518`; that item stays open until this lands and the suite stops flaking. <!-- relates:7518 --> <!-- id:81d5 -->
