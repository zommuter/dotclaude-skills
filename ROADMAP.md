...
- [ ] [ROUTINE] **The `id:b54b` hermeticity backstop fires on RELAY worktrees during a concurrent `/relay` run -- `.claude/worktrees/` is excluded for this reason but the relay worktree root is not.** -- detail: `docs/ledger-notes/c132.md` <!-- id:c132 -->
