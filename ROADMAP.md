...
- [ ] [ROUTINE] 🔴🔴 **HIGHEST PRIORITY — owner directive 2026-08-18: work this FIRST, ahead of every other item in this file.** **Parallelise `tests/run-tests.sh` — MEASURE the speedup first; do not assume it** <!-- id:f69b -->
