...
- [ ] [ROUTINE] **Rule 2c's budget guard is INERT in Workflow-nested children: the dispatch prompt spells the worktree with a literal `~`, the child passes `$(pwd)`, and the literal marker match can never succeed** -- detail: `docs/ledger-notes/5295.md` <!-- relates:c219 --> <!-- relates:ff30 --> <!-- relates:5eeb --> <!-- id:5295 -->
