...
- [x] **[ROUTINE]** integrate.sh step 8: bind the declared-public remote push to the whole repo's ratification queue, not the current unit (Acceptance A) (after id:(seam 1 above)) — seam of id:7408 (auto, id:3801) <!-- id:5ad9 -->
