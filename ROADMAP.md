...
- [ ] [ROUTINE] **LOCALIZED: the parked `id:3bd4`/`id:4f0f` hang is ONE missing `idx += 1` on the fall-through path of a hand-rolled `while` loop; the one-line fix takes all 4 tests to rc=0.** -- detail: `docs/ledger-notes/be51.md` <!-- relates:3bd4 --> <!-- relates:4f0f --> <!-- id:be51 -->
