...
- [x] [ROUTINE] **A multi-match self-marker is resolved by picking the newest mtime, so `context-budget.sh --self` can report ANOTHER child's byte count as an authoritative verdict** -- detail: `docs/ledger-notes/6d7e.md` <!-- relates:5295 --> <!-- relates:5f6a --> <!-- relates:34b7 --> <!-- id:6d7e -->
