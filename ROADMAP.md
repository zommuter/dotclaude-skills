...
- [x] **[ROUTINE]** Add a repo dimension to the head-length and shape-prose baseline keys — seam of id:4839 (auto, id:3801) -- PARKED: prior NEEDS-WORK attempt on an orphan branch; read the note -- detail: `docs/ledger-notes/c655.md` <!-- id:c655 -->
