...
- [ ] [ROUTINE] **Teach `lint-pipefail-sigpipe.py` the SCRIPT consumer -- `producer | bash <script>` whose script exits before draining stdin SIGPIPEs the producer, and the id:81d5 sweep never counted it.** -- detail: `docs/ledger-notes/6294.md` <!-- relates:7518 --> <!-- relates:81d5 --> <!-- relates:ebd0 --> <!-- id:6294 -->
