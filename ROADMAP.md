...
- [ ] [INPUT — decision] **Does PERMANENT Fable change the Opus-apex posture?** (raised 2026-07-28; deliberately split from id:aa26 so a mechanical retirement cannot silently re-decide a standing directive) <!-- id:698d -->
