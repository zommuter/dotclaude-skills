...
- [ ] [HARD — pool] Integrator: distinguish a ZERO-COMMIT review branch from a duplicate dispatch — checkpoint the reviewed tip, never handback (found 2026-07-01, run relay-20260701-202806-14640) <!-- id:8e3e -->
...
- [ ] [ROUTINE] `ckpt-tag.sh`: sync `[repos.<name>]` `last_ckpt` (+ `last_strong_ckpt`/`strong_model` when strong) in relay.toml via `relay-state-write.sh toml-set` (found 2026-07-01: tags 1948/2019/2110 minted by supervised sessions while relay.toml stayed at 1635) <!-- id:0a3b -->
