...
- [ ] **[ROUTINE]** mechanical-proxy: a `relay-mech-stdin` fence on a MULTI-STAGE pipeline misdelivers the payload to the FIRST stage -- refuse it (reverse-handoff promotion, review run relay-20260908-174448-4421) <!-- id:09e4 -->
