...
- [ ] [ROUTINE] `classify-repo.sh` — exempt whole gated/deferred ROADMAP sections from `actionable_routine_open` (align with `roadmap-lint.sh` `is_exempt_heading`) (routed:dfc1) <!-- id:356f -->
