...
- [ ] [HARD] **Build the `/inflownistration` skill -- three modes plus a parameter-less ROUTER, scope RATIFIED 2026-08-21 (promoted from TODO.md id:32c3, single-id-two-views)** -- detail: `docs/ledger-notes/32c3.md` OWNER RULING 2026-09-10: NEITHER mode reads the marks -- id:93d6's constraint on (b) stands; the CLAUDE.md (c) amendment's "belongs to (b)" clause is SUPERSEDED (cross-repo amendment pending). <!-- id:32c3 -->
