...
{
  printf '# Roadmap\n\n## Items\n\n'
  # printf'd: an ADDED source line beginning `- [ ] ... [HARD - meeting]` would trip the
  # pre-commit lane-vocab ratchet, and this is a fixture row, not a ledger item.
  printf -- '- [ ] %s A roadmap-only meeting item <!-- id:aaaa -->\n' '[HARD - meeting]'
  printf -- '- [ ] [INPUT - meeting] An item present in BOTH ledgers <!-- id:cccc -->\n'
} >"$tmp/src/repoTD/ROADMAP.md"
