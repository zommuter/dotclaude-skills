...
|---|---|---|
| `relay/references/executor-contract.md` | `contract vN` HTML-comment marker (currently v11) | `/relay executor` + the `## Relay contract` pointer must agree on `vN`; bump discipline documented in-file |
...
## Relay contract <!-- relay-executor contract v11 -->
