...
relay_FILES := SKILL.md \
               ...
               scripts/classify-verdict.sh scripts/classify-repo.sh scripts/reconcile-repo.sh scripts/backtest-verdict.py \
...
relay_EXEC  := scripts/discover-repos.sh scripts/ckpt-tag.sh scripts/probe-fable.sh \
               ...
               scripts/host-gate.sh scripts/classify-verdict.sh scripts/classify-repo.sh scripts/reconcile-repo.sh scripts/backtest-verdict.py \
               scripts/backtest-historical.py \
               scripts/decision-queue.sh \
               scripts/file-surface-decisions.sh
