...
relay_FILES := SKILL.md \
               ...
               references/deny-tail-probe.md \
               scripts/discover-repos.sh scripts/ckpt-tag.sh scripts/fable-config.sh \
               ...
               scripts/scan-routed.sh scripts/host-gate.sh scripts/context-budget.sh scripts/self-transcript.sh scripts/transcript-shape-preflight.sh scripts/recipe-validate.sh scripts/lane-convert.sh scripts/lane-delimiter-scan.sh scripts/lane-delimiter-convert.sh \
               ...
               scripts/lib-repo-section.sh scripts/lib-clean-tree.sh \
               ...
               scripts/fixture-branch-leak-scan.sh scripts/expires-on-scan.sh scripts/review-box-tick.py \
