...
relay_FILES := SKILL.md \
               ...
               scripts/roadmap-lint.sh scripts/redispatch-guard.mjs scripts/handback-guard.mjs scripts/handback-summary.mjs scripts/pool-args.mjs scripts/drain.mjs scripts/drain-driver.mjs \
